import type {Metadata} from '../../zip/src/node_modules/next';
import './globals.css';
import { Toaster } from "@/components/ui/toaster";

export const metadata: Metadata = {
  title: 'EternalPage | Experiencias Románticas',
  description: 'Crea y comparte una página interactiva única para esa persona especial.',
};
